...
$conn = new PDO('sqlite:///prepared.db');

# Build SQL SELECT statement and return the geometry as a GeoJSON element
$sql = 'SELECT *, GEOMETRY AS full_address FROM location';
...
while ($row = $rs->fetch(PDO::FETCH_ASSOC)) {
    ...
    unset($properties['full_address']);
    unset($properties['GEOMETRY']);
    $feature = array(
         'type' => 'Feature',
         'geometry' => json_decode(wkb_to_json($row['full_address'])),
